...
import com.eleonardo.bluefood.domain.pagamento.DadosCartao;
import com.eleonardo.bluefood.domain.pagamento.Pagamento;
import com.eleonardo.bluefood.domain.pagamento.PagamentoRepository;
import com.eleonardo.bluefood.domain.pagamento.StatusPagamento;
import com.eleonardo.bluefood.domain.pedido.Carrinho;
import com.eleonardo.bluefood.domain.pedido.ItemPedido;
import com.eleonardo.bluefood.domain.pedido.ItemPedidoPK;
import com.eleonardo.bluefood.domain.pedido.ItemPedidoRepository;
import com.eleonardo.bluefood.domain.pedido.Pedido;
import com.eleonardo.bluefood.domain.pedido.PedidoRepository;
import com.eleonardo.bluefood.domain.pedido.Pedido.Status;
...
public class PedidoService {
	...
	public Pedido criarEPagar(Carrinho carrinho, String numCartao) throws PagamentoException {
		...
		HttpEntity<DadosCartao> requentEntity = new HttpEntity<DadosCartao>(dadosCartao, headers);

		RestTemplate restTemplate = new RestTemplate();
		Map<String, String> response;

		try {
			response = restTemplate.postForObject(sbPayUrl, requentEntity, Map.class);
		} catch (Exception e) {
