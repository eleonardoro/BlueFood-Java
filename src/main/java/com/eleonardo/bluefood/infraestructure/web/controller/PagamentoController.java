...
import com.eleonardo.bluefood.application.service.PagamentoException;
import com.eleonardo.bluefood.application.service.PedidoService;
...
public class PagamentoController {
	...
	public String pagar(@RequestParam("numCartao") String numCartao, @ModelAttribute("carrinho") Carrinho carrinho, SessionStatus sessionStatus, Model model) {
